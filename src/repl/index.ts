...
import {
    ...
    alias, unalias, registerJsFunction, onRegistryChange, awaitSchema, exec, registerCompletion,
...
async function loadRc(customPath: string | undefined): Promise<void> {
    ...
    const jshApi: Record<string, unknown> = {
        ...
        alias, unalias, registerJsFunction, onRegistryChange, awaitSchema, exec,
